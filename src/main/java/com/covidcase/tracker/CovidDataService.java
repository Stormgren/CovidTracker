...
public class CovidDataService {
    ...
    @PostConstruct //After this service instance is constructed, run fetchData method
    @Scheduled(cron = "* * 1 * * *") //Used to rerun this on first hour of new day
